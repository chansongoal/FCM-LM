...
def train_one_configuation_hyper(lambda_value, epochs, learning_rate, batch_size, patch_size):
...
if __name__ == "__main__":
    ...
    for lambda_value in lambda_value_all:
        ...
        train_one_configuation_hyper(lambda_value, epochs, learning_rate, batch_size, patch_size)